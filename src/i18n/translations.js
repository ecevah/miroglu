export const translations = {
  en: {
    ...
    gallery: {
      title: "Gallery",
      subtitle: "Snapshots from our fleet and operations",
    },
    cta: {
      contact: "Contact Us",
    },
    ...
    cookie: {
      ...
      long: 'We use strictly necessary cookies to provide information society services via our website. In addition, in order to improve your experience, carry out advertising/marketing activities for you, make the site more functional, and perform performance analysis so that we can improve our site, cookies that can also be accessed by our third‑party business partners are intended to be used. Non‑essential cookies will not be used if you do not give consent.\n\nDepending on your preference, your personal data may be processed by Google Inc., which is located abroad, for the purposes of carrying out advertising/marketing activities for you, making the website more functional and personalization (ensuring that your other preferences, except your privacy preference, are remembered when you revisit the site). You can indicate your preferences regarding optional cookies by clicking the "Manage Cookie Preferences" statement.\n\nFor detailed information about the cookies used by us and our third‑party business partners and your preference rights regarding these cookies, you can review the Cookie Disclosure Text.\n\n*You can change your preferences at any time from the [Personal Data Protection] section accessible via the link available at the bottom of the web page.',
    },
  },
  tr: {
    map: {
    ...
    gallery: {
      title: "Galeri",
      subtitle: "Filomuzdan ve operasyonlarımızdan kareler",
    },
    cta: {
      contact: "Bize Ulaşın",
    },
    ...
    stats: {
      heading: "Rakamlarla Miroğlu",
      countries: {
        label: "Ülke",
        description: "Hizmet verdiğimiz ülkeler",
      },
      companies: {
        label: "Çalışılan Firma",
        description: "Güvenilir iş ortaklarımız",
      },
      journeys: {
        label: "Mutlu Yolculuk",
        description: "Başarıyla tamamlanan teslimatlar",
      },
    },
    langCode: "TR",
    langName: "Türkçe",
    cookie: {
      ...
      message:
        '"Kabul Et" butonuna tıklayarak cihazınızda çerezlerin saklanmasını kabul etmiş olursunuz.',
      accept: "Kabul Et",
      reject: "Reddet",
      more: "Daha fazla",
      manage: "Çerez Tercihlerimi Yönet",
      privacy: "Kişisel Verilerin Korunması",
      long: "Web sitemiz üzerinden bilgi toplumu hizmetlerinin sunulması için zorunlu çerezler kullanmaktayız. Ayrıca deneyiminizin iyileştirilmesi, size yönelik reklam/pazarlama faaliyetlerinin gerçekleştirilmesi sitenin daha işlevsel bulunması ve sitemizin geliştirilebilmesi için performans analizinin gerçekleştirilmesi kapsamında üçüncü taraf iş ortaklarımızın da erişebileceği çerezler kullanılmak istenmektedir. Zorunlu olmayan çerezler onay vermediğiniz durumlarda kullanılmayacaktır.\n\nKişisel verileriniz tercihinize bağlı olarak size yönelik reklam/pazarlama faaliyetlerinin gerçekleştirilmesi, Web sitesinin daha işlevsel kılınması ve kişiselleştirme (gizlilik tercihiniz hariç olmak üzere diğer tercihlerinizin siteye tekrar girdiğinizde hatırlanmasını sağlamak) amaçlarıyla yurt dışında bulunan Google Inc. tarafından işlenebilecektir. İsteğe bağlı çerezlere ilişkin tercihlerinizi “Çerez Tercihlerimi Yönet” ibaresine tıklayarak belirtebilirsiniz.\n\nBizim ve üçüncü taraf iş ortaklarımızın kullandığı çerezlere ve bu çerezlere ilişkin tercih haklarına ilişkin detaylı bilgiler için Çerez Aydınlatma Metni ni inceleyebilirsiniz.\n\n*Tercihlerinizi her zaman internet sayfasının altında mevcut olan bağlantı vasıtasıyla erişilebilen [Kişisel Verilerin Korunması] sekmesinden değiştirebilirsiniz.",
    },
  },
};
